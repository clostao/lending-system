...
export const DebtTokenABI = [
    ...
    },
    {
        ...
        "outputs": [
            {
                "internalType": "contract ProtocolController",
                "name": "",
                "type": "address"
            }
        ],
    ...
    },
    {
        ...
        "name": "normalizeDebtToCurrentExchangeRate",
        "outputs": [
            {
                "internalType": "uint256",
                "name": "",
...
export const ProtocolControllerABI = [
    {
        "inputs": [
            {
                "internalType": "address",
    ...
    },
    {
        ...
        "name": "calculateAmountOfCollateral",
        "outputs": [
            {
                "internalType": "uint256",
                "name": "",
